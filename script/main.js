...
//100 and activates overlay else its moves and adds the current score to the finalscore value
function hold() {
...
//roll random dice roll between 1 and 6 and append it to its image file name
function rollDice() {
...
function newGame() {
  ...
  // todo: is this useful? Yes this allows the winning overlay to be also used as a way to start the game just by clicking on it
